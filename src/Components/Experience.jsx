...
export default function Experience() {
  return (
    <div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-5 mt-12 w-[90%] mx-auto p-5 bg-gray-200/70 rounded-lg shadow-lg md:w-[70%]">
        <div className=" w-[90%] mx-auto p-5 bg-gray-200/70 rounded-lg shadow-lg md:w-[70%]">
          <span className="text-xl font-semibold text-gray-400/90 mt-2">
            Frontend Developer
          </span>
